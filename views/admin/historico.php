...
<body onload="cargarHistorico();">
    ...
    <div class="container-fluid">
        <div class="card text-center m-2">
            ...
            <div class="card-body">
                    <input onkeyup="cargarHistorico();" class="form-control m-auto w-25 border border-primary border-2" type="search" placeholder="Buscar..." aria-label="Search" name="campo" id="campo">
